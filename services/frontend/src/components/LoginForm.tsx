  ...
  return (
    ...
    >
      ...
      <input
        type="email"
        placeholder="Email"
        className="input-visible-border w-full h-12 px-3 rounded shadow-md focus:border-blue-500 focus:ring-2 focus:ring-blue-200 focus:bg-blue-50 transition text-base"
        value={email}
